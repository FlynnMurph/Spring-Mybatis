...
<head>
    ...
    <link rel="stylesheet" href="${webroot}/layer/layer.css "/>
    <!-- text fonts -->
                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="red">启发</span>
                            <span class="white" id="id-text2">后台应用</span>
                        </h1>
                        <h4 class="blue" id="id-company-text">&copy; 大宝</h4>
                    </div>
                                        ...
                                        <fieldset>
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Username" name="userAccount" id="userAccount"/>
...
<script src="${webroot}/layer/layer.js"></script>
<!-- <![endif]-->
